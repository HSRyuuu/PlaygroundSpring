...
public class MyPublisher implements Flow.Publisher<Message> {
    ...
    public void subscribe(Flow.Subscriber<? super Message> subscriber) {
        System.out.println(
                "Thread " + Thread.currentThread().getName() + ", " + "Called subscribe() in MyPublisher # 구독자 추가 #");
    ...
    public void notifySubscribers(Message message) {
        System.out.println(
                "Thread "
                        ...
                        + ", "
                        + "Called notifySubscribers() in MyPublisher # 메시지 발행 # ");
    ...
    public void close() {
        System.out.println(
                "Thread " + Thread.currentThread().getName() + ", " + "Called close() in MyPublisher");
        for (Flow.Subscriber<? super Message> subscriber : subscribers) {
